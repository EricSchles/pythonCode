...
I'm just using classes like they were functions.
I end up trying to do too much in the objects.
These are supposed to be templates, not functions.
I should only have the invariants in my classes
The classes should help me write better functions.
This is where the player interaction should take place.
Write now I am just creating more work for myself.

I am only keeping this file to remind me of what not to do.
"""
class Scene(object):
